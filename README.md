...
void key()
{
    for (int row = 0; row < 4; row++)
    {
        ...
        Lcd_cursor(&lcd, 0, 0); // Set cursor

        if (!col1)
        {
            Lcd_string(&lcd, "Key: ");
            Lcd_char(&lcd, keys[row][0]);
            HAL_Delay(300);
        }
        else if (!col2)
        {
            Lcd_string(&lcd, "Key: ");
            Lcd_char(&lcd, keys[row][1]);
            HAL_Delay(300);
        }
        else if (!col3)
        {
            Lcd_string(&lcd, "Key: ");
            Lcd_char(&lcd, keys[row][2]);
            HAL_Delay(300);
        }
        else if (!col4)
        {
            Lcd_string(&lcd, "Key: ");
            Lcd_char(&lcd, keys[row][3]);
            HAL_Delay(300);
        }
    }
}
...
## Output screen shots of proteus  :
 <img width="1148" height="868" alt="image" src="https://github.com/user-attachments/assets/851318b7-885a-4019-8d74-a270cbf687aa" />

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="1142" height="790" alt="image" src="https://github.com/user-attachments/assets/c9b14f56-a17c-49b7-9def-ef883a3672c8" />
